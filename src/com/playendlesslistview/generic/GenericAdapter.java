...
public abstract class GenericAdapter<T> extends BaseAdapter {
	...
	protected static final int VIEW_TYPE_ACTIVITY = 1;
	...
	public void setServerListSize(int serverListSize){
		...
		Log.d("eric", "serverListSize is: " + serverListSize);
	}
	...
	protected abstract View getDataRow(int position, View convertView, ViewGroup parent);
